...
public class DisplayScreen {
	...
	public static void main(String[] args) {
		Screen.flow("This paragraph shows that new-line characters and dashes are supported.\n   this piece\n   shows that\n   spaces are kept\nAnd by now you've surely noticed the scroll-functionality. Califragialisticexpialodouscious is a long word that can't break, so it simply flows to the next line.");
